    ...
    public partial class Addmodel : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.TB_M_Supplier", t => t.supp_Id, cascadeDelete: true)
                .Index(t => t.supp_Id);
            ...
            CreateTable(
                ...
                c => new
                    {
                        supp_Id = c.Int(nullable: false, identity: true),
                        Name = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.TB_M_Item", "supp_Id", "dbo.TB_M_Supplier");
            ...
            DropIndex("dbo.TB_M_Item", new[] { "supp_Id" });
